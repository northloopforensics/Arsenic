Arsenic is a mobile triage tool designed for iOS and Android devices. Key features include backup creation, data parsing with timezone awareness, advanced photo classification using scene taxonomy, and detailed analysis of communications data (SMS, call history, app interactions). 
